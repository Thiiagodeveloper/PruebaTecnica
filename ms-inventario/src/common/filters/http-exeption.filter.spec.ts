...
// Mocks para los objetos de NestJS
...
describe('HttpExceptionFilter', () => {
            ...
            errors: [
                {
                    ...
                    detail: 'Error Ocurrido', // En este caso, title y detail pueden ser iguales
                },
            ],
        });
    });
    ...
    it('should handle class-validator HttpException (array of messages)', () => {
        const validationErrorResponse = {
            ...
            error: 'Bad Request', // class-validator a veces añade esto
